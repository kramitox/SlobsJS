...
function messageHandler(slobs)
{
	...
	if (data.id === ID_SCENES) {
		//console.log(util.inspect(data.result, true, null, true));
...
function toggleSourceVisible(slobs,sceneName, sourceName) {
  ...
  const scene = scenesMap.get(sceneName)
  //console.log(util.inspect(scenesMap, true, null, true));
  //console.log(sceneName);
  //console.log(source);
  //console.log(source.childrenIds.length);
